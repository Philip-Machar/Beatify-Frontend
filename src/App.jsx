    ...
    <div className="min-h-screen bg-gray-950 text-gray-100 p-6">
      <div className="max-w-2xl mx-auto space-y-8">
        ...
        <div className="flex flex-col items-center space-y-6">
          ...
          <div className="w-full h-[300px] aspect-video bg-gray-900/30 backdrop-blur-md rounded-2xl shadow-xl border border-gray-800/50 overflow-hidden flex justify-center items-center">
            <AudioVisualizer 
